...
class MarkdownPlugin {
    register(tailwindConfigFile = 'tailwind.config.js', ...args) {
        mix
            .js('vendor/cauriland/foundation/resources/assets/js/markdown-editor/markdown-editor.js', 'public/js/markdown-editor.js')
            .postCss('vendor/cauriland/foundation/resources/assets/css/markdown-editor.css', 'public/css', [importCss(), tailwindCss(tailwindConfigFile)])
    }
