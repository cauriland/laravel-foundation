...
namespace CauriLand\Foundation\CommonMark\Extensions\Highlighter;

use CauriLand\Foundation\CommonMark\Extensions\Highlighter\Concerns\DecodesHtmlEntities;
...
final class FencedCodeRenderer implements NodeRendererInterface, XmlNodeRendererInterface
{
    ...
    /** @var \CauriLand\Foundation\CommonMark\Extensions\Highlighter\CodeBlockHighlighter */
    private $highlighter;
