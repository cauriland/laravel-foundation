...
namespace CauriLand\Foundation\Hermes\Models;

use CauriLand\Foundation\Fortify\Models\Concerns\HasLocalizedTimestamps;
...
abstract class DatabaseNotification extends BaseNotification
{
    ...
    {
        return data_get($this->data, 'action.title', trans('ui::actions.view'));
    }
