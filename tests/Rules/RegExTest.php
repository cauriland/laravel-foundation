...
use CauriLand\Foundation\Rules\RegEx;
...
it('extracts the twitter username from a twitter url', function ($url) {
    expect(RegEx::getTwitterUsername($url))->toBe('cauriland');
})->with([
    'https://twitter.com/cauriland',
    'https://twitter.com/cauriland/',
    'https://twitter.com/cauriland/?test=test&foo=bar',
    'https://twitter.com/cauriland?test=test&foo=bar',
]);
...
it('extracts the domain from a given url', function ($domain, $url) {
    ...
    ['cauri.cm', 'https://cauri.cm'],
    ['cauri.cm', 'https://www.cauri.cm'],
    ['learn.cauri.cm', 'https://learn.cauri.cm'],
