...
use CauriLand\Foundation\CommonMark\Extensions\Image\MediaUrl;
use CauriLand\Foundation\CommonMark\Extensions\Image\TwitterRenderer;
...
it('should render twitter embeds', function () {
    $response = [
        'url'  => 'https://twitter.com/cauriland/status/1234',
    ...
    $mediaUrl = new MediaUrl('twitter', 'cauriland/status/1234');
