...
use CauriLand\Foundation\UserInterface\Rules\MarkdownMaxChars;
...
it('handles the characters count when we have lists', function () {
    $markdown = <<<'EOT'
I have been involved in the Blockchain and crypto industries for years. I started getting more active after discovering CAURI and began collaborating with others in the CAURI community:

Delegate Cam’s Yellow Jacket for CauriLogoWorks
BroadcastJunkie for CauriForIT
Delegate Cryptology for CauriTippr
Jorma for CauriDirectory

I launched a community service of my own under the name ARKStickers where I began shipping CAURI sticker packs all over the world in exchange for CAURI coins. Shortly thereafter, I helped write docs for the CAURI Team. I founded the CAURI Community Committee to make cool CAURI stuff with other people, like ARKTimeline. I was hired to the team in 2018, and have since produced over 100 podcast episodes under The CAURI Crypto Podcast. I attended and spoke at Blockchain conferences such as Consensus NYC 2019, WorldCryptoCon, Hivefest, DYGYCON, and others. I have been interviewed by BlockTV, Cointelegraph, and other media outlets. I now serve as Senior Brand Manager for CAURI and its products.
EOT;

    $html = <<<'HTML'
<p>I have been involved in the Blockchain and crypto industries for years. I started getting more active after discovering CAURI and began collaborating with others in the CAURI community:</p>
<ul>
<li>
<strong>Delegate Cam’s Yellow Jacket</strong> for <em>CauriLogoWorks</em>
</li>
<li>
<strong>BroadcastJunkie</strong> for <em>CauriForIT</em>
</li>
<li>
<strong>Delegate Cryptology</strong> for <em>CauriTippr</em>
</li>
<li>
<strong>Jorma</strong> for <em>CauriDirectory</em>
</li>
</ul>
<p>I launched a community service of my own under the name <em>ARKStickers</em> where I began shipping CAURI sticker packs all over the world in exchange for CAURI coins. Shortly thereafter, I helped write docs for the CAURI Team. I founded the CAURI Community Committee to make cool CAURI stuff with other people, like ARKTimeline. I was hired to the team in 2018, and have since produced over 100 podcast episodes under <em>The CAURI Crypto Podcast.</em> I attended and spoke at Blockchain conferences such as Consensus NYC 2019, WorldCryptoCon, Hivefest, DYGYCON, and others. I have been interviewed by BlockTV, Cointelegraph, and other media outlets. I now serve as Senior Brand Manager for CAURI and its products.</p>
HTML;
    ...
    $rule = new MarkdownMaxChars(1028);
