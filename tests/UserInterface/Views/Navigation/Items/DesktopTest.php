...
it('should render the component with a single item without query parameters', function (): void {
    Route::view('/', 'cauri::navbar.items.desktop')->name('home');

    $this
        ->assertView('cauri::navbar.items.desktop', createAttributes([
            'navigation' => [
...
it('should render the component with children', function (): void {
    Route::view('/', 'cauri::navbar.items.desktop')->name('home');
    Route::view('/post', 'cauri::navbar.items.desktop')->name('post');
