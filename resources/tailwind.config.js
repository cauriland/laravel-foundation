...
module.exports = {
    ...
    purge: {
        ...
        content: [
            ...
            "./vendor/cauriland/foundation/resources/views/**/*.blade.php",
            "./vendor/cauriland/fortify/resources/views/**/*.blade.php",
            "./vendor/cauriland/hermes/resources/views/**/*.blade.php",
            "./resources/js/**/*.js",
            "./resources/js/**/*.vue",
            "./app/**/*.php",
        ],
