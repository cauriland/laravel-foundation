 ...
 *
 * This is a copy of https://www.github.com/orestbida/cookieconsent with minor adjustments for Cauri.Land-related projects
 */
(function () {
    "use strict";
    /**
    ...
    var CookieConsent = function (root) {
        ...
        var _config = {
            ...
            avoid_explicit_domain: true, // default: do not explicitly set the domain
            cookie_path: "/",
        ...
        var _setConfig = function (_user_config) {
            ...
            if (typeof user_config["avoid_explicit_domain"] === "boolean")
                _config.avoid_explicit_domain =
                    user_config["avoid_explicit_domain"];
        ...
        _cookieconsent.run = function (user_config) {
            if (!document.getElementById("cc_div")) {
                ...
                consent_modal_exists =
                    !cookie_consent_accepted || !valid_revision;
