window.UserTagger = (
    ...
    const options = {
        ...
        containerClass:
            "cauri-user-tagger bg-white rounded-md shadow-lg py-6 z-50 left-0 sm:left-auto w-full sm:w-auto",
        ...
        menuItemTemplate(item) {
            ...
            return `<div class="flex p-3 space-x-3 items-center cursor-pointer">
                ...
                <span class="cauri-user-tagger--username font-semibold text-theme-secondary-800">${
