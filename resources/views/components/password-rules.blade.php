        ...
        >
            @foreach($passwordRules as $ruleName => $ruleIsValid)
                <div class="flex items-center space-x-2 min-w-1/3">
                    @if ($ruleIsValid)
                        <div class="flex flex-shrink-0 justify-center items-center w-5 h-5 rounded-full bg-theme-success-200 dark:bg-theme-success-900">
                            <x-cauri-icon name="check-mark-bold" size="2xs" style="success" />
                    @elseif(! $ruleIsValid)
                    ...
                    @else
                        <div class="flex flex-shrink-0 justify-center items-center w-5 h-5 rounded-full bg-theme-danger-200">
                            <x-cauri-icon name="exclamation" style="danger" />
                    @endif
                        </div>
