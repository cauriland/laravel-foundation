...
<div class="inline-block relative pointer-events-none avatar-wrapper">
    <div class="relative w-11 h-11">
            ...
            @elseif($identifier)
                <x-cauri-avatar :identifier="$identifier" class="object-cover absolute w-full h-full rounded-xl" />
            @elseif($defaultLogo)
        ...
        <div class="flex absolute top-0 right-0 justify-center items-center -m-4 text-transparent rounded-full">
            <div class="flex flex-shrink-0 items-center justify-center rounded-full h-8 w-8 {{ $stateColor }} group-hover:bg-theme-success-50 dark:group-hover:bg-theme-success-900">
                @if ($type === CauriLand\Foundation\Hermes\Enums\NotificationTypeEnum::DANGER)
                    <div class="flex flex-shrink-0 justify-center items-center w-6 h-6 rounded-full dark:text-white text-theme-danger-400 bg-theme-danger-50 dark:bg-theme-danger-400">
                        <x-cauri-icon name="circle.cross" size="sm" />
                    </div>
                @elseif ($type === CauriLand\Foundation\Hermes\Enums\NotificationTypeEnum::SUCCESS)
                    <div class="flex flex-shrink-0 justify-center items-center w-6 h-6 rounded-full dark:text-white text-theme-success-600 bg-theme-success-50 dark:bg-theme-success-600">
                        <x-cauri-icon name="circle.plus" size="sm" />
                    </div>
                @elseif ($type === CauriLand\Foundation\Hermes\Enums\NotificationTypeEnum::WARNING)
                    <div class="flex flex-shrink-0 justify-center items-center w-6 h-6 rounded-full dark:text-white text-theme-warning-600 bg-theme-warning-50 dark:bg-theme-warning-600">
                        <x-cauri-icon name="circle.minus" size="sm" />
                    </div>
                @elseif ($type === CauriLand\Foundation\Hermes\Enums\NotificationTypeEnum::BLOCKED)
                    <div class="flex flex-shrink-0 justify-center items-center w-6 h-6 rounded-full dark:text-white text-theme-secondary-900 bg-theme-secondary-200 dark:bg-theme-secondary-700">
                        <x-cauri-icon name="ban" size="sm" />
                    </div>
                @elseif ($type === CauriLand\Foundation\Hermes\Enums\NotificationTypeEnum::COMMENT)
                    <div class="flex flex-shrink-0 justify-center items-center w-6 h-6 rounded-full dark:text-white text-theme-secondary-900 bg-theme-secondary-200 dark:bg-theme-secondary-700">
                        <x-cauri-icon name="message-empty" size="xs" />
                    </div>
                @elseif ($type === CauriLand\Foundation\Hermes\Enums\NotificationTypeEnum::MENTION)
                    <div class="flex flex-shrink-0 justify-center items-center w-6 h-6 rounded-full dark:text-white text-theme-secondary-900 bg-theme-secondary-200 dark:bg-theme-secondary-700">
                        <x-cauri-icon name="at" size="sm" />
                    </div>
                @elseif ($type === CauriLand\Foundation\Hermes\Enums\NotificationTypeEnum::ANNOUNCEMENT)
                    <div class="flex flex-shrink-0 justify-center items-center w-6 h-6 rounded-full dark:text-white text-theme-warning-600 bg-theme-warning-50 dark:bg-theme-warning-600">
                        <x-cauri-icon name="bell" size="sm" />
                    </div>
                @elseif ($type === CauriLand\Foundation\Hermes\Enums\NotificationTypeEnum::VIDEO)
                    <div class="flex flex-shrink-0 justify-center items-center w-6 h-6 rounded-full dark:text-white text-theme-secondary-900 bg-theme-secondary-200 dark:bg-theme-secondary-700">
                        <x-cauri-icon name="play" size="xs" />
                    </div>
                @endif
            </div>
        </div>
