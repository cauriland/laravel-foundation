...
<div id="markdown-editor-{{ $id ?? $name }}" class="cauri-markdown-editor with-line-numbers cauri-markdown-editor-{{ $toolbar }} {{ $class ?? '' }}">
    <div class="input-group">
        ...
        <div class="input-wrapper">
            ...
            >
                ...
                <div wire:ignore>
                    @include('cauri::inputs.includes.markdown.navbar', ['toolbar' => $toolbar])

                    @include('cauri::inputs.includes.markdown.navbar', ['toolbar' => $toolbar, 'mobile' => true])
                </div>
        ...
        @include('cauri::inputs.includes.input-error')
    </div>
</div>
