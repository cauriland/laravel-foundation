...
<html lang="en">
    <head>
        ...
        <title>{{ config('app.name', 'CAURI Documentation') }}</title>
        ...
        <!-- Meta --->
        <meta property="og:title" content="{{ $errorType }} - Error | CAURI Documentation" />
            ...
            <main class="container flex flex-1 items-center px-4 mx-auto w-full sm:px-8 sm:max-w-full lg:max-w-7xl">
                <div class="w-full bg-white rounded-xl">
                    <div class="flex flex-col justify-center items-center space-y-8">
                        ...
                        <div class="text-lg font-semibold text-center text-theme-secondary-900">{{ CauriLand\Foundation\UserInterface\UI::getErrorMessage($errorType) }}</div>
                        <div class="space-x-3">
