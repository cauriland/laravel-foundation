<div>
    <div class="flex flex-col">
        ...
        <form class="mt-8" wire:submit.prevent="updateProfileInformation">
            <div class="space-y-4">
                <x-cauri-input type="text" name="name" model="state.name" :label="trans('ui::forms.name')" :errors="$errors" />
                <x-cauri-input type="email" name="email" model="state.email" :label="trans('ui::forms.email_address')" :errors="$errors" />
            </div>
