<div dusk="logout-other-browser-sessions">
    ...
    @if (count($this->sessions) > 0)
        <div class="hidden mt-8 md:flex">
            <x-cauri-tables.table class="w-full">
                <thead>
                    <x-cauri-tables.row>
                        <x-cauri-tables.header name="ui::pages.logout-sessions.ip" class="text-sm font-semibold"/>
                        <x-cauri-tables.header name="ui::pages.logout-sessions.os" class="text-sm font-semibold"/>
                        <x-cauri-tables.header name="ui::pages.logout-sessions.browser" class="text-sm font-semibold"/>
                        <x-cauri-tables.header name="ui::pages.logout-sessions.last_active" class="text-sm font-semibold text-right"/>
                    </x-cauri-tables.row>
                </thead>
    ...
    @if($this->modalShown)
        <x-cauri-modal title-class="header-2" width-class="max-w-2xl" wire-close="closeModal">
            <x-slot name="title">
            ...
            <x-slot name="description">
                <div class="flex justify-center mt-8 w-full">
                    <x-cauri-icon name="fortify-modal.secure" size="h-28" />
                </div>
