<div>
    ...
    @if($this->modalShown)
        <x-cauri-modal title-class="header-2" width-class="max-w-xl" wire-close="closeModal">
            <x-slot name="title">
            ...
            <x-slot name="description">
                <div class="flex flex-col">
                    <div class="flex justify-center w-full">
                        <x-cauri-icon name="fortify-modal.delete-account" class="mt-8 mb-4 w-60 h-auto text-theme-primary-600 light-dark-icon"/>
                    </div>

                    @if($alert)
                        <div class="mt-4">
                            <x-cauri-alert :type="$alertType" class="py-4 mx-auto">
                                {!! $alert !!}
                            </x-cauri-alert>
                        </div>
                    @endif
                ...
                <div class="flex flex-col mt-4">
                    ...
                    <x-cauri-input name="confirmedName" model="confirmedName" label=" " :placeholder="trans('modals.delete-user.input_placeholder')"></x-cauri-input>
                </div>
                @endif
